					...
					<div class="card-body ">
						<div class="row p-b-20">
							<div class="col-md-6 col-sm-6 col-6">
								<div class="btn-group">
									<a href="/admin/service/create" id="addRow" class="btn btn-info"> Add New <i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-6">
							...
							<table class="table table-hover table-checkable order-column full-width" id="example4">
								...
								<tbody>
									<c:forEach var="service" items="${serviceList}">
										<tr class="odd gradeX">
											<td class="center">${service.serviceName}</td>
											<td class="center">${service.unit}</td>
											<td class="center">${service.price}</td>
											<td class="center">${service.description}</td>
											<td class="center"><a href="/admin/service/${service.serviceId}" class="btn btn-tbl-edit btn-xs"> <i class="fa fa-pencil"></i>
