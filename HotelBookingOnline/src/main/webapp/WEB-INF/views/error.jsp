...
<!-- Fav and touch icons -->
<link rel="shortcut icon" sizes="144x144" href="${resources}/assets/images/favicon-icon/apple-touch-icon-144-precomposed.png">
...
<body>
	<!-- Header Start Here -->
	<%@include file="/WEB-INF/views/templates/client/header.jsp" %>
	<!-- Header End Here -->
	<!-- Content -->
	<section>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb_parent text-center">
								<h2 class="page_title white-text">Error 404</h2>
								<ul class="breadcrumb">
	...
	<section class="padding_75">
		<div class="container">
			<div class="row">
				<div class="light_grayBG error404">
					<h1>
						4<span>0</span>4
					</h1>
	...
	<!-- Content End -->
	<!-- Footer Start Here -->
	<%@include file="/WEB-INF/views/templates/client/footer.jsp" %>
	<!-- Footer End Here -->
	<div id="scrollToTop">
		<a href="#"> <i class="fa fa-angle-up white-text" aria-hidden="true"></i>
		</a>
	</div>
	<!-- Scripts -->
	<!-- Optional JavaScript -->
